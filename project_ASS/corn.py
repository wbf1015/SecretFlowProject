...
def ABY3_ASS():
    ...
    logger.info('System init a PYU device Webserver2')
    pyu_webserver3 = sf.PYU('Webserver3')
    logger.info('System init a PYU device Webserver3')
    pyu_webserver4 = sf.PYU('Webserver4')
    logger.info('System init a PYU device Webserver4')
    pyu_webserver5 = sf.PYU('Webserver5')
    logger.info('System init a PYU device Webserver5')
